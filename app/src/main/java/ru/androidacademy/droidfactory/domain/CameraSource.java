 ...
 * <p>
 * Управление камерой и обновление UI, передача данных детекторам(например детектору штрих-кодов)
 */
public class CameraSource {
    ...
    public static final int HIGH_REQUESTED_CAMERA_PREVIEW_WIDTH = 1920;
    public static final int HIGH_REQUESTED_CAMERA_PREVIEW_HEIGHT = 1080;
    ...
    private SizePair getResolution(Camera camera) {
        if (Build.VERSION.SDK_INT <= 27) {
            return selectSizePair(camera, DEFAULT_REQUESTED_CAMERA_PREVIEW_WIDTH, DEFAULT_REQUESTED_CAMERA_PREVIEW_HEIGHT);
        } else {
            return selectSizePair(camera, HIGH_REQUESTED_CAMERA_PREVIEW_WIDTH, HIGH_REQUESTED_CAMERA_PREVIEW_HEIGHT);
        }
    }
